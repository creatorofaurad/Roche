      ...
      <main style={{ flexGrow: 1 }}>
        ...
        <section style={{ maxWidth: "1200px", margin: "2rem auto 0", padding: "0 1.5rem" }}>
          <h2 style={{
            ...
            <span style={{ color: "#00d9ff" }}>■ </span>VERIFIED EXPLOITS (MAINNET)
          </h2>
          ...
          <div style={{
            ...
            <article style={{
              ...
              <div>
                <div style={{ borderBottom: "1px solid #003344", paddingBottom: "1rem", marginBottom: "1.25rem" }}>
                  <div style={{ fontSize: "1.05rem", fontWeight: 700, color: "#ffffff", fontFamily: "'IBM Plex Mono', monospace" }}>COINBASE CBETH</div>
                  <div style={{ fontSize: "0.875rem", color: "#00d9ff", margin: "0.25rem 0 0.85rem", fontFamily: "'IBM Plex Mono', monospace" }}>Atomic Rate Jump Arbitrage</div>
                  <div style={{ display: "flex", justifyContent: "space-between", fontSize: "0.8rem", fontFamily: "'IBM Plex Mono', monospace", marginBottom: "0.35rem" }}>
                    <span style={{ color: "#c0c0c0" }}>Impact:</span>
                    <span style={{ color: "#ff00ff", fontWeight: 700 }}>$2,800,000 per $100M TVL</span>
                  </div>
                  <div style={{ display: "flex", justifyContent: "space-between", fontSize: "0.8rem", fontFamily: "'IBM Plex Mono', monospace", marginBottom: "0.35rem" }}>
                    <span style={{ color: "#c0c0c0" }}>Severity:</span>
                    <span style={{ color: "#ffaa00", fontWeight: 700 }}>HIGH</span>
                  </div>
                  <div style={{ display: "flex", justifyContent: "space-between", fontSize: "0.8rem", fontFamily: "'IBM Plex Mono', monospace" }}>
                    <span style={{ color: "#c0c0c0" }}>Status:</span>
                    <span>Published (Cantina)</span>
                  </div>
                </div>

                <div style={{ fontSize: "0.875rem", color: "#c0c0c0", lineHeight: 1.5, marginBottom: "1.5rem" }}>
                  <div style={{ fontSize: "0.75rem", textTransform: "uppercase", letterSpacing: "0.05em", color: "#ffffff", marginBottom: "0.35rem", fontFamily: "'IBM Plex Mono', monospace" }}>Root Cause:</div>
                  <p>
                    Discrete oracle updates violate continuity invariant. Step jump exploitable via frontrun/backrun sandwich in same block.
                  </p>
                  <div style={{ backgroundColor: "rgba(0, 0, 0, 0.25)", border: "1px solid #003344", padding: "0.75rem", fontSize: "0.775rem", fontFamily: "'IBM Plex Mono', monospace", marginTop: "1rem" }}>
                    Detection: Roche sequence #8472<br />
                    Proof: 50,000-sequence fuzzing run
                  </div>
                </div>
              </div>

              <a href="https://github.com/creatorofaurad/Roche/blob/main/docs/INSTITUTIONAL.md" style={{ color: "#00d9ff", fontSize: "0.825rem", fontFamily: "'IBM Plex Mono', monospace", fontWeight: 700, textDecoration: "none" }}>
                → Read Full Finding
              </a>
            </article>
            ...
            <article style={{
              ...
              <div>
                <div style={{ borderBottom: "1px solid #003344", paddingBottom: "1rem", marginBottom: "1.25rem" }}>
                  <div style={{ fontSize: "1.05rem", fontWeight: 700, color: "#ffffff", fontFamily: "'IBM Plex Mono', monospace" }}>SOLANA PUMP.FUN</div>
                  <div style={{ fontSize: "0.875rem", color: "#00d9ff", margin: "0.25rem 0 0.85rem", fontFamily: "'IBM Plex Mono', monospace" }}>Cross-Instruction Fee Tier Sandwich</div>
                  <div style={{ display: "flex", justifyContent: "space-between", fontSize: "0.8rem", fontFamily: "'IBM Plex Mono', monospace", marginBottom: "0.35rem" }}>
                    <span style={{ color: "#c0c0c0" }}>Impact:</span>
                    <span style={{ color: "#ff00ff", fontWeight: 700 }}>20 bps repeatable drain</span>
                  </div>
                  <div style={{ display: "flex", justifyContent: "space-between", fontSize: "0.8rem", fontFamily: "'IBM Plex Mono', monospace", marginBottom: "0.35rem" }}>
                    <span style={{ color: "#c0c0c0" }}>Severity:</span>
                    <span style={{ color: "#ffaa00", fontWeight: 700 }}>HIGH</span>
                ...
                <div style={{ fontSize: "0.875rem", color: "#c0c0c0", lineHeight: 1.5, marginBottom: "1.5rem" }}>
                  <div style={{ fontSize: "0.75rem", textTransform: "uppercase", letterSpacing: "0.05em", color: "#ffffff", marginBottom: "0.35rem", fontFamily: "'IBM Plex Mono', monospace" }}>Root Cause:</div>
                  <p>
                    Discrete fee tier calculation breaks piecewise-marginal integration. Tier boundary straddling exploitable.
                  </p>
                  <div style={{ backgroundColor: "rgba(0, 0, 0, 0.25)", border: "1px solid #003344", padding: "0.75rem", fontSize: "0.775rem", fontFamily: "'IBM Plex Mono', monospace", marginTop: "1rem" }}>
                    Detection: Roche sequence #6974<br />
                    Proof: Jito bundle atomicity
                  </div>
                </div>
              </div>
            ...
            <article style={{
              ...
              <div>
                <div style={{ borderBottom: "1px solid #003344", paddingBottom: "1rem", marginBottom: "1.25rem" }}>
                  <div style={{ fontSize: "1.05rem", fontWeight: 700, color: "#ffffff", fontFamily: "'IBM Plex Mono', monospace" }}>POLYGON AGGLAYER</div>
                  <div style={{ fontSize: "0.875rem", color: "#00d9ff", margin: "0.25rem 0 0.85rem", fontFamily: "'IBM Plex Mono', monospace" }}>Vault Bridge Uninitialized Storage</div>
                  <div style={{ display: "flex", justifyContent: "space-between", fontSize: "0.8rem", fontFamily: "'IBM Plex Mono', monospace", marginBottom: "0.35rem" }}>
                    <span style={{ color: "#c0c0c0" }}>Impact:</span>
                    <span style={{ color: "#ff3366", fontWeight: 700 }}>$19,000,000 permanent loss</span>
                  </div>
                  <div style={{ display: "flex", justifyContent: "space-between", fontSize: "0.8rem", fontFamily: "'IBM Plex Mono', monospace", marginBottom: "0.35rem" }}>
                    <span style={{ color: "#c0c0c0" }}>Severity:</span>
                    <span style={{ color: "#ff3366", fontWeight: 700 }}>CRITICAL</span>
                  </div>
                  <div style={{ display: "flex", justifyContent: "space-between", fontSize: "0.8rem", fontFamily: "'IBM Plex Mono', monospace" }}>
                    <span style={{ color: "#c0c0c0" }}>Status:</span>
                    <span>Published (Cantina)</span>
                ...
                <div style={{ fontSize: "0.875rem", color: "#c0c0c0", lineHeight: 1.5, marginBottom: "1.5rem" }}>
                  <div style={{ fontSize: "0.75rem", textTransform: "uppercase", letterSpacing: "0.05em", color: "#ffffff", marginBottom: "0.35rem", fontFamily: "'IBM Plex Mono', monospace" }}>Root Cause:</div>
                  <p>
                    ERC-4626 proxy _disableInitializers invoked on implementation. Proxy storage never initialized. totalAssets() reverts unconditionally.
                  </p>
                  <div style={{ backgroundColor: "rgba(0, 0, 0, 0.25)", border: "1px solid #003344", padding: "0.75rem", fontSize: "0.775rem", fontFamily: "'IBM Plex Mono', monospace", marginTop: "1rem" }}>
                    Detection: Roche mainnet scanner<br />
                    Proof: Cast storage verification
                  </div>
                </div>
              </div>
